...
export default /* @ngInject */ function TelecomTelephonyBillingAccountPhonebookCtrl(
  ...
  self.deletePhonebook = function deletePhonebook() {
    ...
    Promise.all([
      import('./remove/billing-account-phonebook-remove.controller').then(mod => (mod.default ? mod.default : mod)),
      import('./remove/billing-account-phonebook-remove.html').then(mod => (mod.default ? mod.default : mod)),
    ]).then(([controller, template]) => $uibModal.open({
      animation: true,
      template,
      controller,
  ...
  self.addPhonebookContact = function addPhonebookContact() {
    ...
    return Promise.all([
      import('./contact-add/billing-account-phonebook-contact-add.controller').then(mod => (mod.default ? mod.default : mod)),
      import('./contact-add/billing-account-phonebook-contact-add.html').then(mod => (mod.default ? mod.default : mod)),
    ])
      .then(([controller, template]) => $uibModal.open({
        animation: true,
        template,
  ...
  self.importPhonebookContact = function importPhonebookContact() {
    ...
    return Promise.all([
      import('./contact-import/billing-account-phonebook-contact-import.controller').then(mod => (mod.default ? mod.default : mod)),
      import('./contact-import/billing-account-phonebook-contact-import.html').then(mod => (mod.default ? mod.default : mod)),
    ])
      .then(([controller, template]) => $uibModal.open({
        animation: true,
        template,
  ...
  self.updatePhonebookContact = function updatePhonebookContact(contact) {
    self.phonebookContact.hasModalOpened = true;
    return Promise.all([
      import('./contact-update/billing-account-phonebook-contact-update.controller').then(mod => (mod.default ? mod.default : mod)),
      import('./contact-update/billing-account-phonebook-contact-update.html').then(mod => (mod.default ? mod.default : mod)),
    ])
      .then(([controller, template]) => $uibModal.open({
        animation: true,
        template,
