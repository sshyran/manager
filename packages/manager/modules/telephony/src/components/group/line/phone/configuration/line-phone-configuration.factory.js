...
export default () => {
  ...
  function TelephonyGroupLinePhoneConfiguration(phoneConfigurationOptionsParam) {
    ...
    this.setValues(phoneConfigurationOptions.value, phoneConfigurationOptions.default);
  }
  ...
  TelephonyGroupLinePhoneConfiguration.prototype.setValues = function setValues(currentValue,
    defaultValue) {
    const self = this;
