  ...
  self.soundListModel = function soundListModel(soundId) {
    if (arguments.length) {
      ...
      if (self.menuCtrl.popoverStatus.rightPage === 'greetSound') {
        return (self.menu.greetSound = soundId); // eslint-disable-line
      }
      return (self.menu.invalidSound = soundId); // eslint-disable-line
    }
      ...
      if (self.menuCtrl.menuEntry && self.menuCtrl.menuEntry.action === 'menuSub' && self.menuCtrl.menuEntry.menuSub) {
        ...
        if (self.menuCtrl.dialplanRule.status === 'DRAFT') {
          ...
          self.menuCtrl.dialplanRule
            .stopEdition(true, self.menuCtrl.dialplanRule.ivrMenu.oldParent);
        }
