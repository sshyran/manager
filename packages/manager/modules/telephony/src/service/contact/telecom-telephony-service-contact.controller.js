...
export default /* @ngInject */ function ($state, $stateParams, $q, $timeout, $translate,
  OvhApiTelephony, TucToast, TucToastError, OvhApiXdsl, tucTelephonyBulk) {
  const self = this;
  ...
  self.onPostCodeChange = (function onPostCodeChangeInit() {
    // var pendingRequest = null;
    return function onPostCodeChange() {
  ...
  self.onSiretChange = (function onSiretChangeInit() {
    const pendingRequest = null;
    return function onSiretChange(model) {
  ...
  self.getWayNameList = (function getWayNameListInit() {
    let pendingRequest = null;
    return function getWayNameList(partialName) {
      let result = $q.when([]);
