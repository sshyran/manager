...
angular.module('managerApp').factory('TelecomTelephonyLineCallsForward', ($translate) => {
  ...
  /**
         ...
         * @type {String}
         */
  Object.defineProperty(TelecomTelephonyLineCallsForward.prototype, 'footPrint', {
    get() {
      return [this.nature.value, this.getCurrentNumber() ? this.getCurrentNumber().serviceName : 'null', this.enable, this.delay].join('#');
    },
    set: angular.noop,
  });
  ...
  /**
         ...
         * @type {String}
         */
  Object.defineProperty(TelecomTelephonyLineCallsForward.prototype, 'saveData', {
    get() {
      const result = {};
      ...
      result[`forward${this.type}Nature`] = this.nature.value === 'external' ? 'number' : this.nature.value;
      if (this.hasDelay) {
